...
class AnsiRenderer:  # =========================================================
    ...
    _LEVEL2ANSI_COLOR = {
        ...
        _CustomLogLevel.NOTE: AnsiStyle.GREY,
        _CustomLogLevel.TIP: AnsiStyle.WHITE,
        _CustomLogLevel.DONE: AnsiStyle.BRIGHT_YELLOW,
        _CustomLogLevel.HINT: AnsiStyle.BLACK,
        _CustomLogLevel.IMPORTANT: AnsiStyle.BRIGHT_WHITE,
